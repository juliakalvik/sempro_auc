      ...
      <div className="mx-auto max-w-2xl lg:pt-36 md:pt-36 pt-10">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="./signup"
              className="rounded-md bg-gray-900 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-turq focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 hover:text-white"
            >
              Join here
            </a>
          </div>
